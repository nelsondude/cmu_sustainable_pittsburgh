...
class rseventsproHelper
{
	...
	public static function subMenu() {
		...
		$views  = array('events','locations','categories','tags','subscriptions','discounts','payments','groups','imports','backup','messages','settings','update');
