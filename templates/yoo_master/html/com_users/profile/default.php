...
<div id="system">
	...
	<h3>View Organization information for <a href="<?php echo JRoute::_('index.php?option=com_gwc&view=companies&id='.$this->data->companyid);?>">		<?php echo $this->data->organization;?></a></h3>
	<?php endif; ?>
